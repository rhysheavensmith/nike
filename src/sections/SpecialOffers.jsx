		...
		<section className='flex justify-wrap items-center max-lg:flex-col-reverse gap-10 max-container'>
			<div className='flex-1'>
				<img
					...
					width={773}
					height={687}
					className='object-contain w-full max-lg:hidden'
				/>
			</div>
			<div className='flex flex-1 flex-col'>
				...
				<p className='mt-6 lg:max-w-lg info-text'>
					Naviagte a realm of possibilites designed to fulfill your unique
					desires, surpassing the loftiest expectations. Your journey with us is
					nothing short of exceptional.
				</p>
				<div className='mt-11 flex flex-wrap gap-4'>
					<Button label='Get it Now' iconURL={arrowRight} />
					<Button
						label='Learn more'
